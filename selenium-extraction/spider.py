...
cidades = ["Sydney", "Recife", "Atenas", "Paris", "Nova York", "Tokyo", "Cidade do Cabo"]
cidades_destid = ["-1603135", "-665520", "-814876", "-1456928", "20088325", "-246227", "-1217214"]
...
for i in range(len(cidades)):
    ...
    try:
        button = driver.find_element(By.XPATH, '//button[@aria-label="Ignorar informações de login."]')
        button.click()
    except:
        pass
